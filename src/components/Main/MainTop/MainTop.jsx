      ...
      <div className="main__top">
        ...
        <ul className="main__top-prices-list">
          <li className="main__top-prices-item">
            <p className='main__top-prices-title'>
              USD = 10891.93 <span><img src={icon1} alt="" /></span>
            </p>
          </li>
          <li className="main__top-prices-item">
            <p className='main__top-prices-title'>
              EUR = 12651.00 <span><img src={icon2} alt="" /></span>
            </p>
          </li>
          <li className="main__top-prices-item">
            <p className='main__top-prices-title'>
              RUB = 190.75 <span><img src={icon2} alt="" /></span>
            </p>
          </li>
        </ul>
      </div>
